                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <option value="Adelaide City">Adelaide</option>
                                                         
                                                            <option value="Brisbane City">Brisbane</option>
                                                            <option value="Canberra City">Canberra</option>
                                                            <option value="Darwin City">Darwin</option>
                                                            
                                                            <option value="Gold Coast City">Gold Coast</option>
                                                            <option value="Las Melbourne City">Melbourne</option>
                                                            
                                                            <option value="Sydney City">Sydney</option>
                                                            
                                                            
                                                            
                                                            <option value="Perth City">Perth </option>
