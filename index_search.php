...
<head>
    ...
    <title>DRAWIN ART COMPANY</title>
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/art.jpg');">
                ...
                <div class="container">
                    <div class="content-center brand">
                        ...
                        <br><br>
                        <h3>Art, Design, Painting, Drawings, Culture.</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <br>
                    <div class="col-md-12">
                        <h2 class="title"> Arts Products</h2>
                            ...
                            <div class="row-sm-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <h6><a class="btn btn-success btn-round" title="Click for more details!" href="pages/product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a>
