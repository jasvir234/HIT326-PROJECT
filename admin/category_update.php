...
{   
    ...
    if(empty($supp_name)) {    
        ...
        //updating the table
        $query = "UPDATE category SET cat_name='$supp_name' WHERE cat_id=$supp_id";
        ...
        ?>
        <script>
        //redirecting to the display page. In our case, it is admin_panel.php
...
<?php
//getting id from url
$id=isset($_GET['cat_id']) ? $_GET['cat_id'] : die('ERROR: Record ID not found.');
//selecting data associated with this particular id
$result = mysqli_query($dbconn, "SELECT * FROM category WHERE cat_id=$id");
while($res = mysqli_fetch_array($result))
{
    $supp_name = $res['cat_name'];
}
?>
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="panel-body">
                                <form action="category_update.php" method="post">
                                    <div class="form group">
                                        <input type="hidden" class="form-control" id="supp_id" name="supp_id" value=<?php echo $_GET['cat_id'];?>>
                        ...
                        <div class="form group">
                            <button type="submit" class="btn btn-success btn-round" id="submit" name="update">
                                <i class="now-ui-icons ui-1_check"></i> Update Category
                            </button>
                        </div>
                        </form>
                    </div>
