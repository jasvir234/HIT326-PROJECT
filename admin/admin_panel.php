...
<body class="profile-page sidebar-collapse">
    ...
    <div class="wrapper">
        <div class="page-header page-header-small" filter-color="orange">
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/art.jpg');"></div>
            <div class="container">
                ...
                <div class="col-md-6 ml-auto mr-auto">
                    ...
                    <div class="nav-align-center">
                        <ul class="nav nav-pills nav-pills-primary" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#category" role="tablist">
                                    <i class="now-ui-icons shopping_tag-content"></i>
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="tab-pane" id="category" role="tabpanel">
                        <div class="col-md-12 ml-auto mr-auto">
                            <div class="row collections">
                                          ...
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                                ...
                                                echo "<td><a href=\"category_update.php?cat_id=$res[cat_id]\">Edit</a> | <a href=\"category_delete.php?cat_id=$res[cat_id]
                                                \" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
                                              echo "</tr>"; 
                                            }
                                          }?>
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="category_add.php"><i class="now-ui-icons ui-1_simple-add"></i> Add Category</a>
                            </div>
                        </div>
                    </div>
