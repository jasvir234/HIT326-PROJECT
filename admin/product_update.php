                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-success panel-size-custom">
                            ...
                            <div class="panel-body">
                              ...
                              $query=mysqli_query($dbconn,"SELECT * FROM products ")or die(mysqli_error());
                              while($row=mysqli_fetch_array($query)){
                                        ...
                                        <div class="form-group">
                                           ...
                                           <input type="text" class="form-control" id="supplier" name="supplier" value="<?php echo $sub;?>"  readonly>
